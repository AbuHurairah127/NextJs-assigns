  ...
  return (
    <div className="bg-gray-50 flex flex-col justify-center items-center">
      ...
      <div className=" p-5 flex flex-col items-center">
        ...
        <p className="w-[85vw] text-center">
          Blockchain: Blockchain is a distributed ledger technology that enables
          secure and transparent transactions between parties without the need
          for intermediaries. Learning blockchain technology involves
          understanding the basics of cryptography, consensus algorithms, and
          smart contracts. There are several blockchain platforms and languages
          to learn, including Ethereum, Solidity, and Hyperledger Fabric.
        </p>
        <p className="w-[85vw] text-center">
          ...
          blockchain, instead of a centralized server. Developing dApps involves
          learning programming languages like JavaScript, as well as frameworks
          and libraries like React, Vue.js, and Truffle.
        </p>
        <p className="w-[85vw] text-center">
          Decentralized Finance (DeFi): Decentralized finance refers to a set of
          financial applications and services that operate on a decentralized
          network, such as a blockchain. Learning about DeFi involves
          understanding concepts like smart contracts, liquidity pools, yield
          farming, and decentralized exchanges (DEXs). Some popular DeFi
          platforms to explore include Uniswap, Aave, and Compound.
        </p>
        <p className="w-[85vw] text-center">
          Artificial Intelligence (AI): AI is a field of computer science that
          focuses on creating machines and software that can perform tasks that
          typically require human intelligence, such as speech recognition,
          natural language processing, and computer vision. Learning about AI
          involves understanding concepts like machine learning, neural
          networks, and deep learning, as well as programming languages like
          Python and frameworks like TensorFlow.
        </p>
        <p className="w-[85vw] text-center">
        ...
        <p className="mt-8">
          Overall, learning about Web 3.0 involves developing a broad range of
          skills and knowledge across multiple disciplines, including computer
          science, mathematics, economics, and cryptography. While the learning
          curve can be steep, there are many resources available online,
          including tutorials, courses, and online communities, that can help
